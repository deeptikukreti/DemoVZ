    ...
    fun setDeviceData() {
        viewModelScope.launch {
            withContext(Dispatchers.Unconfined) {
                ...
                deviceList1.add(Device("AC", false, feature = Feature(1,"Cooling","30","%")))
                deviceList1.add(Device("Ceiling Lights", false,feature = Feature(1,"Brightness","50","%")))
                deviceList1.add(Device("Room Heater", false,feature = Feature(1,"Heating","30","%")))
                deviceList1.add(Device("Cabinet Lights", false,feature = Feature(1,"Brightness","80","%")))
                deviceList1.add(Device("TV", false,feature = Feature(1,"Volume","15","%")))
                val area1 =
            ...
            withContext(Dispatchers.Unconfined) {
                ...
                deviceList2.add(Device("AC", false, feature = Feature(1,"Cooling","30","%")))
            ...
            withContext(Dispatchers.Unconfined) {
                ...
                deviceList3.add(Device("Led Lights", false,feature = Feature(1,"Brightness","15","%")))
                deviceList3.add(Device("Chimney", false,feature = Feature(2,"Mode","Normal Mode","")))
                deviceList3.add(Device("Refrigerator", false,feature = Feature(2,"Mode","Normal Mode","%")))
                deviceList3.add(Device("Smart Coffeemaker", false,feature = Feature(2,"Model","Normal Mode","%")))
                val area3 =
            ...
            withContext(Dispatchers.Unconfined) {
                ...
                deviceList4.add(Device("AC", false,feature = Feature(1,"Cooling","38","%")))
